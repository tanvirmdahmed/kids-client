        ...
        <div className="carousel w-full max-h-[840px] rounded-lg mb-12">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex flex-col justify-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <h3 className='text-md md:text-3xl lg:text-6xl font-extrabold text-[#FFFFFF] mb-1 lg:mb-4 ml-6 md:ml-14 lg:ml-20'>WE PLAY AND LEARN:</h3>
                    <h3 className='text-md md:text-3xl lg:text-6xl font-extrabold text-[#FFDE5A] mb-3 ml-6 md:ml-14 lg:ml-20'>WHO SAID EDUCATION WAS BORING?</h3>
                    <div>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute flex flex-col justify-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    ...
                    <h3 className='text-md md:text-3xl lg:text-6xl font-extrabold text-[#FFDE5A] mb-3 ml-6 md:ml-14 lg:ml-20'>WHO SAID EDUCATION WAS BORING?</h3>
                    <div>
                        <button className="btn btn-accent sm:text-md ml-6 md:ml-14 lg:ml-20">Join With Us</button>
                    </div>
                </div>
                <div className="absolute flex gap-4 bottom-5 right-5">
                    <a href="#slide3" className="btn btn-circle">❮</a>
